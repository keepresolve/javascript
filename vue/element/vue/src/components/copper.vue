        ...
        <div class="content">
            ...
            <div class="show-info">
                ...
                <div class="test test1">
                    <vueCropper ref="cropper" :img="option.img" :outputSize="option.size" :outputType="option.outputType" :info="true" :full="option.full" :canMove="option.canMove" :canMoveBox="option.canMoveBox" :fixedBox="option.fixedBox" :original="option.original" :autoCrop="option.autoCrop"
                        :autoCropWidth="option.autoCropWidth" :autoCropHeight="option.autoCropHeight" :centerBox="option.centerBox" :high="option.high" :infoTrue="option.infoTrue" :maxImgSize="option.maxImageSize" @realTime="realTime" @imgLoad="imgLoad" @cropMoving="cropMoving"
                ...
                <div style="display:block; width: 100%;">
                    <label class="c-item">
                        ...
                        <section>类似css background属性设置 设置不符合规范不生效， 参照文档说明</section>
                    </label>
                    <label class="c-item">
    ...
    methods: {
        changeImg() {
            this.option.img = this.lists[
                Math.floor(Math.random() * this.lists.length)
            ].img;
        },
        startCrop() {
            // start
