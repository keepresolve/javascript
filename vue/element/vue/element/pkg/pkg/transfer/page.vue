        ...
        <div class="cTransfer-wrapper">
            ...
            <div class="cTransfer-slide" v-loading="loading">
                ...
                <div class="cTransfer-slide-header" :style="{marginBottom:hiddenSelect?'14px':''}">
                    ...
                    <!-- 全选 -->
                    <div>
                        <el-checkbox v-if="!hiddenSelect" :indeterminate="isIndeterminate" v-show="filterData.length>0" v-model="checkAll" @change="handleCheckAllChange">全选</el-checkbox>
                    </div>
                </div>
                ...
                <div class="cTransfer-slide-footer">
